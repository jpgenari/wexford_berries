...
A few minor error were flagged by [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2Fwexford-berries-229479cc7505.herokuapp.com%2F). Related to how the tool reads repeated templates, Mailchimp code and structure from walkthrough project where this project is based on. Throughout manual testing, it was identified these minor error have no impact when running e-commerce application.
![W3C validation screenshot](/documentation/html-validator.png)
